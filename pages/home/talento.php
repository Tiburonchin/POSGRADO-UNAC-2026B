<section class="w-full py-24 relative overflow-hidden">
    ...
    <div class="marquee-container mt-8">
        <div class="marquee-track" id="logoTrack">
            ...
            <!-- Tarjeta 2: La Contraloría -->
            <div class="logo-card">
                <img src="img/logos/contraloria.jpg" alt="La Contraloría General de la República" loading="lazy">
            </div>

            <!-- Tarjeta 3: Gobierno Regional Callao -->
            <div class="logo-card">
                <img src="img/logos/gobierno_regional_callao.png" alt="Gobierno Regional del Callao" loading="lazy">
            </div>

            <!-- Tarjeta 4: Scotiabank -->
            <div class="logo-card">
