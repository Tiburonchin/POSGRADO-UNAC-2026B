...
<aside class="social-sidebar fixed right-6 top-1/2 z-[60] -translate-y-1/2 hidden lg:flex flex-col gap-4" id="social-sidebar">
    <div class="social-sidebar-inner flex flex-col gap-4 p-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10">
        <a href="https://www.facebook.com/PosgradoUNAC" target="_blank" rel="noopener noreferrer" class="social-link group relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 hover:bg-unac-blue" aria-label="Facebook">
        ...
        <a href="https://www.instagram.com/epg_unac/" target="_blank" rel="noopener noreferrer" class="social-link group relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 hover:bg-gradient-to-tr hover:from-yellow-400 hover:to-purple-600" aria-label="Instagram">
        ...
        <a href="https://www.linkedin.com/company/upgfca/?originalSubdomain=pe" target="_blank" rel="noopener noreferrer" class="social-link group relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 hover:bg-[#0077b5]" aria-label="LinkedIn">
        ...
        <a href="https://wa.me/51900970371" target="_blank" rel="noopener noreferrer" class="social-link group relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 hover:bg-[#25d366]" id="whatsapp-link" aria-label="WhatsApp">
